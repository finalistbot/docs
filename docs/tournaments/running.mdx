...
| Entry attachments | Off, optional, or required — see [Entry attachments](../organizers/entry-attachments). |
...
history, and your organization's [leaderboards](../organizers/results#leaderboards). A
